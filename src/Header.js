...
const Header = ({
  ...
  return (
    <header className="p-2 bg-slate-700 -top-1 z-10 flex justify-center gap-1 items-between text-xl font-display flex-col w-[100%] md:p-3">
      <div className="relative flex justify-between gap-1 items-center flex-row w-auto flex-grow md:space-x-3">
        {width < 1024 && (
          <>
            ...
            <button
              ...
              <div
                className="toggle-btn w-6 h-0.5 sm:w-8 bg-white sm:h-0.5 md:w-10 md:h-1 xl:w-12 xl:h-0.5 absolute transition-all duration-100 before:content-[''] before:bg-white before:w-6 before:h-0.5 sm:before:h-0.5 sm:before:w-8 md:before:w-10 md:before:h-1 xl:before:w-12 xl:before:h-0.5 before:absolute before:-translate-x-3 
        ...
        <Link
          to="/"
          onClick={homeClose}
          className="md:bg-emerald-500 px-2 rounded-lg">
          <div className="flex justify-center items-center">
            <img
              src={width > 640 ? blackLogo : logo}
              alt="Duck Logo"
            ...
            <div className="flex flex-grow justify-center items-center">
              <form className="w-[100%]" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="relative w-full">
                  <input
                    className="text-xl md:text-3xl bg-slate-800 w-[100%] px-2 rounded"
                    type="text"
                    id="search"
                    autoComplete="off"
